...
class PaymentManager extends BaseService implements PaymentManagerInterface
{
    ...
    public function confirmPayment(ConfirmPaymentInterface $confirmPayment): ConfirmPaymentResponseModel
    {
        ...
        $client->request()->parameters($this->confirmPaymentToParameters($confirmPayment))->send();
        ...
        return [
            ...
            'additionalData' =>
                (object)array(
                    ...
                    'singleTransactionRegulation' => $confirmPayment->getSingleTransactionRegulation())
        ];
    }
