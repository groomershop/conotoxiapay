...
class RawClient implements RawClientInterface
{
    ...
    /**
     * @param resource|bool|CurlHandle $curl
     *
     * @throws IncompatibilityException
    ...
    {
        $request = $this->signedRequest ? $this->securityManager->encodeRequest($this->parameters) : json_encode_array($this->parameters, false, (RequestModelInterface::JSON_OBJECT === $this->requestType));
