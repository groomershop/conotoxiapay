...
class ConfirmPaymentEndpoint implements EndpointInterface
{
    ...
    protected function assignInput(array $parameters): ?ProcessedInputInterface
    {
        ...
        if (isset($parameters["additionalData"]->singleTransactionRegulation)) {
            $result->setSingleTransactionRegulation($parameters["additionalData"]->singleTransactionRegulation);
        }
